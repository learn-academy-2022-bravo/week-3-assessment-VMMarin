...
describe("filteredNumbers", () => {
  ...
  () => }
  expect(filteredNumbers(fullArr1, fullArr2)).toEqual(filteredNumbers)
...
describe("accumulatingSum", () => {
  ...
  () => }
  expect(numberstoAdd1, numbersToAdd2, numbersToAdd3.toEqual(accumulatingSum)
...
console.log(array.map(accumulatingSum))